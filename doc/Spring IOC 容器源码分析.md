...
step：1 创建一个工程 ayuantalking-spring

step：2 在pom.xml文件中加入spring-context容器
``` 
...
```
加入 spring-context 会自动将 spring-core、spring-beans、spring-aop、spring-expression 这几个基础 jar 包带进来。
